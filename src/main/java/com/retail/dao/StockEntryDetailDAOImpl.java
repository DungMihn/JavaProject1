...
public class StockEntryDetailDAOImpl implements StockEntryDetailDAO {
    ...
    private static final String UPDATE_STOCK_ENTRY_DETAIL = "UPDATE Stock_Entry_Detail SET stock_entry_id = ?, product_id = ?, quantity = ?, purchase_price = ? WHERE stock_entry_detail_id = ?";
    ...
    try (Connection conn = DatabaseConnection.getConnection();
         CallableStatement cstmt = conn.prepareCall("{CALL sp_AddStockEntryDetail(?, ?, ?, ?)}")) {
    ...
    public void updateStockEntryDetail(StockEntryDetail stockEntryDetail) {
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(UPDATE_STOCK_ENTRY_DETAIL)) {
    ...
    public void deleteStockEntryDetail(int stockEntryDetailId) {
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(DELETE_STOCK_ENTRY_DETAIL)) {
    ...
    public StockEntryDetail getStockEntryDetailById(int stockEntryDetailId) {
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(GET_STOCK_ENTRY_DETAIL_BY_ID)) {
    ...
    public List<StockEntryDetail> getAllStockEntryDetails() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(GET_ALL_STOCK_ENTRY_DETAILS)) {
    ...
    public List<StockEntryDetail> getStockEntryDetailsByStockEntryId(int stockEntryId) {
        ...
        String query = "SELECT * FROM Stock_Entry_Detail WHERE stock_entry_id = ?";
        try (Connection conn = DatabaseConnection.getConnection();
