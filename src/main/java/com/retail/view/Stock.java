...
public class Stock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ManageProducts.setText("MANAGE STOCK ENTRY");
        ...
        stockEntryTable.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        stockEntryTable.setRowHeight(25);
        stockEntryTable.setSelectionForeground(new java.awt.Color(255, 102, 0));
        TableProducts.setViewportView(stockEntryTable);

        ProductList.setFont(new java.awt.Font("Century Gothic", 1, 24)); // NOI18N
        ProductList.setForeground(new java.awt.Color(255, 102, 51));
        ProductList.setText("STOCK ENTRY LIST");
