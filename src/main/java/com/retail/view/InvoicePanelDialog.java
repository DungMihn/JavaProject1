...
public class InvoicePanelDialog {
    ...
    private void initLogic() {
        ...
        quantityField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            @Override
            public void insertUpdate(DocumentEvent e) { updateEditingRow(); }
            @Override
            public void removeUpdate(DocumentEvent e) { updateEditingRow(); }
            @Override
            public void changedUpdate(DocumentEvent e) { updateEditingRow(); }
        });
        ...
        invoicePanel.getTxtDiscount().getDocument().addDocumentListener(new DocumentListener() {
            ...
            @Override
            public void insertUpdate(DocumentEvent e) { validateDiscount(); updateSummary(); }
            @Override
            public void removeUpdate(DocumentEvent e) { validateDiscount(); updateSummary(); }
            @Override
            public void changedUpdate(DocumentEvent e) { validateDiscount(); updateSummary(); }
        });
        ...
        invoicePanel.getBtnViewInvoiceDetails().addActionListener(e -> viewInvoiceDetails());
    ...
    private void viewInvoiceDetails() {
        ...
        // Gọi dialog hiển thị chi tiết hóa đơn từ file InvoicePanelDetail
        InvoicePanelDetail.showInvoiceDetail(JOptionPane.getFrameForComponent(invoicePanel), invoiceId);
    }
